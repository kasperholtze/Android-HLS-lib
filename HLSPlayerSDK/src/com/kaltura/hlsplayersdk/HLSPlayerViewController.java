...
TextTracksInterface, AlternateAudioTracksInterface, QualityTracksInterface, SegmentCachedListener, KnowledgePrepHandler {
    ...
    //    boolean isSeeking() { return ???; }
    //    boolean isStopped() { return ???; }
    //    boolean isPaused() { return ???; }
    //    boolean qualityChanging() { return ???; }
    //    boolean buffering() { return ???; }
    //    
    //    
    ...
    //    	{
    //    	case FSM_STOPPED:
    //    		if (isSeeking() && haveUrl()) gotoState(FSM_SEEKING);
    //    		else if (haveUrl() gotoState(FSM_LOAD);
    //    		else gotoState(FSM_STOPPED);
    //    		break;
    //    	case FSM_LOAD:
    //    		if ()
    //    		break;
